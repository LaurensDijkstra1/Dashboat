...
import { TButton, TRadio, TSelect, TTable } from 'vue-tailwind/dist/components'
...
const settings = {
  ...
  't-select': {
    ...
    props: {
      fixedClasses:
        'block w-full pl-3 pr-10 py-1 transition duration-100 ease-in-out border rounded shadow-sm ' +
